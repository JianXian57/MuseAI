...
def _service_failure(
    ...
    mappings: list[tuple[type[BaseException], str, str]] = [
        ...
        (
            StandingFileNotFoundError,
            "STANDING_FILE_NOT_FOUND",
            "The Standing Task file does not exist.",
        ),
        (
            InvalidStandingDateError,
            "INVALID_STANDING_DATE",
            "The Standing Task target date is invalid.",
        ),
        (
            InvalidStandingScheduleError,
            "INVALID_STANDING_SCHEDULE",
            "The Standing Task schedule is invalid.",
        ),
        (
            StandingNotScheduledError,
            "STANDING_NOT_SCHEDULED",
            "The Standing Task is not scheduled for the requested date.",
        ),
        (
            StandingGenerationDateRegressionError,
            "STANDING_GENERATION_DATE_REGRESSION",
            "The Standing generation date cannot move backward.",
        ),
        (
            InvalidStandingDocumentError,
            "INVALID_STANDING_DOCUMENT",
            "The Standing Task document is invalid.",
        ),
        (
            UnsupportedSchemaVersionError,
        ...
        (
            StandingTaskError,
            "STANDING_TASK_ERROR",
            "The Standing Task service failed.",
        ),
        (
            TaskServiceError,
            "TASK_SERVICE_ERROR",
